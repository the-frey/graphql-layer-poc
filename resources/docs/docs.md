...
The `home-routes` handler in the `graphql-layer-poc.routes.home` namespace
...
The `home-page` function will in turn call the `graphql-layer-poc.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/graphql_layer_poc/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `graphql-layer-poc.handler` namespace:
...
Request middleware functions are located under the `graphql-layer-poc.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `graphql-layer-poc.dev-middleware` namespace found in
